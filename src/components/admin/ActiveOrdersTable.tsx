  ...
  return (
    <>
      {!order.status && order.active && (
        <Button size="small" ghost className="text-xs text-cyan hover:border-cyan" onClick={() => reactToPrintFn()}>
                ...
                <div>
                  <div className="flex flex-row">
                    <div>
                      ...
                      <h3>{`Order Date & Time : ${year}-${month}-${day} ${hours}:${minutes}:${seconds} ${amOrPm}`}</h3>
                      <Divider className="mt-2 mb-3" />
                      <h3 className="text-slate-600 text-xs">Note : Order will delivery up to two business days.</h3>
                    </div>
